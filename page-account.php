                                ...
                                <div class="col-md-3">
                                    <div class="dashboard-menu">
                                        <ul class="nav flex-column" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="/frontendpage-login.php"><i class="fi-rs-sign-out mr-10"></i>Logout</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-content account dashboard-content pl-50">
                                        ...
                                        <div class="tab-pane fade" id="account-detail" role="tabpanel" aria-labelledby="account-detail-tab">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <p>Already have an account? <a href="/frontendpage-login.php">Log in instead!</a></p>
