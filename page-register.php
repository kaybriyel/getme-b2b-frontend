                            ...
                            <div class="row">
                                    ...
                                    <div class="login_wrap widget-taber-content background-white">
                                        <div class="padding_eight_all bg-white">
                                            <div class="heading_s1">
                                                ...
                                                <p class="mb-30">Already have an account? <a href="/frontend/page-login.php">Login</a></p>
                                            </div>
                                            <form method="post">
                                                ...
                                                <div class="login_footer form-group mb-50">
                                                    ...
                                                    <a href="/frontend/page-privacy-policy.php"><i class="fi-rs-book-alt mr-5 text-muted"></i>Lean more</a>
                                                </div>
                                ...
                                <div class="col-lg-6 pr-30 d-none d-lg-block">
                                    <div class="card-login mt-115">
                                        <a href="/frontend/#" class="social-login facebook-login">
                                            <img src="/frontend/assets/imgs/theme/icons/logo-facebook.svg" alt="" />
                                            <span>Continue with Facebook</span>
                                        </a>
                                        <a href="/frontend/#" class="social-login google-login">
                                            <img src="/frontend/assets/imgs/theme/icons/logo-google.svg" alt="" />
                                            <span>Continue with Google</span>
                                        </a>
                                        <a href="/frontend/#" class="social-login apple-login">
