                                    ...
                                    <div class="login_wrap widget-taber-content background-white">
                                        <div class="padding_eight_all bg-white">
                                            <div class="heading_s1">
                                                ...
                                                <p class="mb-30">Already have an account? <a href="/frontendpage-login.php">Login</a></p>
                                            </div>
                                            <form method="post">
                                                ...
                                                <div class="login_footer form-group mb-50">
                                                    ...
                                                    <a href="/frontendpage-privacy-policy.php"><i class="fi-rs-book-alt mr-5 text-muted"></i>Lean more</a>
                                                </div>
