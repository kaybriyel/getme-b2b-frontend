                ...
                <div class="archive-header-3 mt-30 mb-80" style="background-image: url(assets/imgs/vendor/vendor-header-bg.png)">
                    <div class="archive-header-3-inner">
                        <div class="vendor-logo mr-50">
                            <img src="/frontend/assets/imgs/vendor/vendor-17.png" alt="" />
                        </div>
                        <div class="vendor-content">
                            <div class="product-category">
                                <span class="text-muted">Since 2012</span>
                            </div>
                            <h3 class="mb-5 text-white"><a href="/frontend/vendor-details-1.php" class="text-white">Nest Food.,Ltd</a></h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="vendor-info text-white mb-15">
                                        <ul class="font-sm">
                                            <li><img class="mr-5" src="/frontend/assets/imgs/theme/icons/icon-location.svg" alt="" /><strong>Address: </strong> <span>5171 W Campbell Ave undefined, Utah 53127 United States</span></li>
                                            <li><img class="mr-5" src="/frontend/assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Call Us:</strong><span>(+91) - 540-025-124553</span></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="follow-social">
                                        ...
                                        <ul class="social-network">
                                            <li class="hover-up">
                                                <a href="/frontend/#">
                                                    <img src="/frontend/assets/imgs/theme/icons/social-tw.svg" alt="" />
                                                </a>
                                            </li>
                                            <li class="hover-up">
                                                <a href="/frontend/#">
                                                    <img src="/frontend/assets/imgs/theme/icons/social-fb.svg" alt="" />
                                                </a>
                                            </li>
                                            <li class="hover-up">
                                                <a href="/frontend/#">
                                                    <img src="/frontend/assets/imgs/theme/icons/social-insta.svg" alt="" />
                                                </a>
                                            </li>
                                            <li class="hover-up">
                                                <a href="/frontend/#">
                                                    <img src="/frontend/assets/imgs/theme/icons/social-pin.svg" alt="" />
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="product-list mb-50">
                            <div class="product-cart-wrap">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="/frontend/shop-product-right.php">Field Roast Chao Cheese Creamy Original</a></h2>
                                    ...
                                    <div class="mt-30 d-flex align-items-center">
                                        <a aria-label="Buy now" class="btn" href="/frontend/shop-cart.php"><i class="fi-rs-shopping-cart mr-5"></i>Add to Cart</a>
                            ...
                            <div class="product-cart-wrap">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="/frontend/shop-product-right.php">Fresh Organic Mustard Leaves</a></h2>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                                            <div class="product-rating" style="width: 90%"></div>
                                        </div>
                            ...
                            <div class="product-cart-wrap">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="/frontend/shop-product-right.php">Organic Green Bell Pepper</a></h2>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                                            <div class="product-rating" style="width: 90%"></div>
                                        </div>
