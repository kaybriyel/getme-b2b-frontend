                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-9 text-end d-none d-xl-block">
                                <ul class="tags-list">
                                    ...
                                    <li class="hover-up">
                                        <a href="/frontendblog-category-grid.php"><i class="fi-rs-cross mr-10"></i>Artichoke</a>
                                    </li>
                                    <li class="hover-up">
                                        <a href="/frontendblog-category-grid.php"><i class="fi-rs-cross mr-10"></i>Celery</a>
                                    </li>
                                    <li class="hover-up mr-0">
                                        <a href="/frontendblog-category-grid.php"><i class="fi-rs-cross mr-10"></i>Spinach</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
