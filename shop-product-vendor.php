            ...
            <div class="page-header breadcrumb-wrap">
                <div class="container">
                    <div class="breadcrumb">
                        ...
                        <span></span> <a href="/frontend/shop-grid-right.php">Vegetables & tubers</a> <span></span> Seeds of Change Organic
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="detail-info pr-30 pl-30">
                                                ...
                                                <div class="detail-extralink mb-50">
                                                    ...
                                                    <div class="product-extra-link2">
                                                        <button type="submit" class="button button-add-to-cart"><i class="fi-rs-shopping-cart"></i>Add to cart</button>
                                                        <a aria-label="Add To Wishlist" class="action-btn hover-up" href="/frontend/shop-wishlist.php"><i class="fi-rs-heart"></i></a>
                                                        <a aria-label="Compare" class="action-btn hover-up" href="/frontend/shop-compare.php"><i class="fi-rs-shuffle"></i></a>
                                                    </div>
                                                </div>
                                                <div class="font-xs">
                                                ...
                                                <div class="tab-pane fade" id="Vendor-info">
                                                    <div class="vendor-logo d-flex mb-30">
                                                        ...
                                                        <div class="vendor-name ml-15">
                                                            <h6>
                                                                <a href="/frontend/vendor-details-2.php">Noodles Co.</a>
                                                            </h6>
                                                            <div class="product-rate-cover text-end">
                                                                <div class="product-rate d-inline-block">
                                                                    <div class="product-rating" style="width: 90%"></div>
                                            ...
                                            <div class="row related-products">
                                                    ...
                                                    <div class="product-cart-wrap hover-up">
                                                        <div class="product-img-action-wrap">
                                                            <div class="product-img product-img-zoom">
                                                                <a href="/frontend/shop-product-right.php" tabindex="0">
                                                            ...
                                                            <div class="product-action-1">
                                                                ...
                                                                <a aria-label="Add To Wishlist" class="action-btn small hover-up" href="/frontend/shop-wishlist.php" tabindex="0"><i class="fi-rs-heart"></i></a>
                                                                <a aria-label="Compare" class="action-btn small hover-up" href="/frontend/shop-compare.php" tabindex="0"><i class="fi-rs-shuffle"></i></a>
                                                            </div>
                                                        ...
                                                        <div class="product-content-wrap">
                                                            <h2><a href="/frontend/shop-product-right.php" tabindex="0">Ulstra Bass Headphone</a></h2>
                                                ...
                                                <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                                    <div class="product-cart-wrap hover-up">
                                                        ...
                                                        <div class="product-content-wrap">
                                                            <h2><a href="/frontend/shop-product-right.php" tabindex="0">Smart Bluetooth Speaker</a></h2>
                                                            <div class="rating-result" title="90%">
                                                                <span> </span>
                                                            </div>
                                                            <div class="product-price">
                                                ...
                                                <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                                    <div class="product-cart-wrap hover-up">
                                                        ...
                                                        <div class="product-content-wrap">
                                                            <h2><a href="/frontend/shop-product-right.php" tabindex="0">HomeSpeak 12UEA Goole</a></h2>
                                                            <div class="rating-result" title="90%">
                                                                <span> </span>
                                                            </div>
                                                            <div class="product-price">
                                                ...
                                                <div class="col-lg-3 col-md-4 col-12 col-sm-6 d-lg-block d-none">
                                                    <div class="product-cart-wrap hover-up mb-0">
                                                        ...
                                                        <div class="product-content-wrap">
                                                            <h2><a href="/frontend/shop-product-right.php" tabindex="0">Dadua Camera 4K 2021EF</a></h2>
                                                            <div class="rating-result" title="90%">
                                                                <span> </span>
                                                            </div>
                                                            <div class="product-price">
                            ...
                            <div class="col-xl-3 primary-sidebar sticky-sidebar mt-30">
                                ...
                                <div class="sidebar-widget widget-vendor mb-30 bg-grey-9 box-shadow-none">
                                    ...
                                    <p>Become a Vendor? <a href="/frontend/page-register.php"> Register now</a></p>
                                </div>
