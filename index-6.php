        ...
        <main class="main">
            <section class="hero-3 position-relative align-items">
                ...
                <ul class="list-inline nav nav-tabs links font-xs text-center">
                    <li class="list-inline-item nav-item"><a class="nav-link font-xs" href="/frontend/shop-grid-right.php">Cake</a></li>
                    <li class="list-inline-item nav-item"><a class="nav-link font-xs" href="/frontend/shop-grid-right.php">Coffes</a></li>
                    <li class="list-inline-item nav-item"><a class="nav-link font-xs" href="/frontend/shop-grid-right.php">Pet Foods</a></li>
                    <li class="list-inline-item nav-item"><a class="nav-link font-xs" href="/frontend/shop-grid-right.php">Vegetables</a></li>
                </ul>
            </section>
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="/frontend/shop-product-right.php">Seeds of Change Organic Quinoe Naturel</a></h2>
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="/frontend/shop-product-right.php">Blue Diamond Almonds Lightly Naturel</a></h2>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                                            <div class="product-rating" style="width: 90%"></div>
                                        </div>
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="/frontend/shop-product-right.php">Chobani Complete Vanilla Greek Bottle</a></h2>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                                            <div class="product-rating" style="width: 90%"></div>
                                        </div>
