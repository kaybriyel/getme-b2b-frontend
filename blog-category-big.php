                                ...
                                <div class="row">
                                        ...
                                        <div class="position-relative overflow-hidden">
                                            ...
                                            <div class="post-thumb border-radius-15">
                                                <a href="/frontend/blog-post-right.php">
                                                    <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-16.png" alt="" />
                                                </a>
                                            </div>
                                        </div>
                                        <div class="entry-content">
                                            <h2 class="post-title mb-20">
                                                <a href="/frontend/blog-post-right.php">Enjoy My Favourite Molten Chocolate Cake in This Autumn </a>
                                            </h2>
                                            ...
                                            <div class="mb-20 entry-meta meta-2">
                                                ...
                                                <a href="/frontend/blog-post-right.php" class="btn btn-sm">Read more<i class="fi-rs-arrow-right ml-10"></i></a>
                                            </div>
                                        </div>
                                    </article>
                                    <article class="first-post mb-30 hover-up animated" style="visibility: visible">
                                        <div class="position-relative overflow-hidden">
                                            ...
                                            <div class="post-thumb border-radius-15">
                                                <a href="/frontend/blog-post-right.php">
                                                    <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-17.png" alt="" />
                                                </a>
                                            </div>
                                        </div>
                                        <div class="entry-content">
                                            <h2 class="post-title mb-20">
                                                <a href="/frontend/blog-post-right.php">The Intermediate Guide to Healthy Food Sticky Ginger Rice</a>
                                            </h2>
                                            <p class="post-exerpt font-medium text-muted mb-30">TAliquam hendrerit lorem mi nunc sit aliquam nec leo, ut integer nisi, iaculis dictumst at diam libero, elit pharetra morbi urna nunc, et at nisl, pellentesque massa nec. Aenean ullamcorper eu augue vitae tempor. Suspendisse potenti. Nulla facilisi. Sed venenatis mollis lacinia.</p>
                                            <div class="mb-20 entry-meta meta-2">
                                                <div class="entry-meta meta-1 mb-30">
                                    ...
                                    <article class="first-post mb-30 hover-up animated" style="visibility: visible">
                                        <div class="position-relative overflow-hidden">
                                            ...
                                            <div class="post-thumb border-radius-15">
                                                <a href="/frontend/blog-post-right.php">
                                                    <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-18.png" alt="" />
                                                </a>
                                            </div>
                                        </div>
                                        <div class="entry-content">
                                            <h2 class="post-title mb-20">
                                                <a href="/frontend/blog-post-right.php">Harissa Chickpeas with Whipped Feta Sticky Ginger</a>
                                            </h2>
                                            <p class="post-exerpt font-medium text-muted mb-30">TAliquam hendrerit lorem mi nunc sit aliquam nec leo, ut integer nisi, iaculis dictumst at diam libero, elit pharetra morbi urna nunc, et at nisl, pellentesque massa nec. Aenean ullamcorper eu augue vitae tempor. Suspendisse potenti. Nulla facilisi. Sed venenatis mollis lacinia.</p>
                                            <div class="mb-20 entry-meta meta-2">
                                                <div class="entry-meta meta-1 mb-30">
