(function ($) {
    ...
    var leafletBasic = function () {
        if ($('#map-basic').length) {
            ...
            L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', {
                maxZoom: 18,
                attribution: 'Map data &copy; <a href="/frontendhttps://www.openstreetmap.org/">OpenStreetMap</a> contributors, ' +
                    '<a href="/frontendhttps://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, ' +
                    'Imagery © <a href="/frontendhttps://www.mapbox.com/">Mapbox</a>',
    ...
    var choropleth = function () {
        if ($('#map-choropleth').length) {
            ...
            map.attributionControl.addAttribution('Population data &copy; <a href="/frontendhttp://census.gov/">US Census Bureau</a>');
    ...
    var crsBasic = function () {
        if ($('#map-panes').length) {
            ...
            var cartodbAttribution = '&copy; <a href="/frontendhttps://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors, &copy; <a href="/frontendhttps://carto.com/attribution">CARTO</a>';
    ...
    var multiMarkColors = function () {
        if ($('#map-multi-marker-colors').length) {
            ...
            L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                attribution: '&copy; <a href="/frontendhttps://www.openstreetmap.org/copyright">OpenStreetMap</a>'
            }).addTo(leaflet);
    ...
    var interactiveMap = function () {
        if ($('#map-interactive').length) {
            ...
            // Init Leaflet Map
            L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                attribution: '&copy; <a href="/frontendhttps://osm.org/copyright">OpenStreetMap</a> contributors'
            }).addTo(leaflet);
