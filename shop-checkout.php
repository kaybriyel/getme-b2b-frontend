...
<head>
    ...
    <!-- Template CSS -->
    <link rel="stylesheet" href="/frontend/assets/css/main.css?v=4.0">
</head>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li><a href="/frontend/#"><img src="/frontend/assets/imgs/theme/flag-fr.png" alt="">Français</a></li>
                                        <li><a href="/frontend/#"><img src="/frontend/assets/imgs/theme/flag-dt.png" alt="">Deutsch</a></li>
                                        <li><a href="/frontend/#"><img src="/frontend/assets/imgs/theme/flag-ru.png" alt="">Pусский</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a class="language-dropdown-active" href="/frontend/#">USD <i class="fi-rs-angle-small-down"></i></a>
                                    <ul class="language-dropdown">
                                        <li><a href="/frontend/#"><img src="/frontend/assets/imgs/theme/flag-fr.png" alt="">INR</a></li>
                                        <li><a href="/frontend/#"><img src="/frontend/assets/imgs/theme/flag-dt.png" alt="">MBP</a></li>
                                        <li><a href="/frontend/#"><img src="/frontend/assets/imgs/theme/flag-ru.png" alt="">EU</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="main-categori-wrap d-none d-lg-block">
                            ...
                            <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                                <div class="d-flex categori-dropdown-inner">
                                    <ul>
                                        <li><a href="/frontend/shop-grid-right.php"> <img src="/frontend/assets/imgs/theme/icons/category-1.svg" alt="">Milks and Dairies</a></li>
                                        <li><a href="/frontend/shop-grid-right.php"> <img src="/frontend/assets/imgs/theme/icons/category-2.svg" alt="">Clothing & beauty</a></li>
                                        <li><a href="/frontend/shop-grid-right.php"> <img src="/frontend/assets/imgs/theme/icons/category-3.svg" alt="">Pet Foods & Toy</a></li>
                                        <li><a href="/frontend/shop-grid-right.php"> <img src="/frontend/assets/imgs/theme/icons/category-4.svg" alt="">Baking material</a></li>
                                        <li><a href="/frontend/shop-grid-right.php"> <img src="/frontend/assets/imgs/theme/icons/category-5.svg" alt="">Fresh Fruit</a></li>
                                    </ul>
                                    <ul class="end">
                                        <li><a href="/frontend/shop-grid-right.php"> <img src="/frontend/assets/imgs/theme/icons/category-6.svg" alt="">Wines & Drinks</a></li>
                                        <li><a href="/frontend/shop-grid-right.php"> <img src="/frontend/assets/imgs/theme/icons/category-7.svg" alt="">Fresh Seafood</a></li>
                                        <li><a href="/frontend/shop-grid-right.php"> <img src="/frontend/assets/imgs/theme/icons/category-8.svg" alt="">Fast food</a></li>
                                        <li><a href="/frontend/shop-grid-right.php"> <img src="/frontend/assets/imgs/theme/icons/category-9.svg" alt="">Vegetables</a></li>
                                        <li><a href="/frontend/shop-grid-right.php"> <img src="/frontend/assets/imgs/theme/icons/category-10.svg" alt="">Bread and Juice</a></li>
                                    </ul>
                                </div>
                                <div class="more_slide_open" style="display: none;">
                                    <div class="d-flex categori-dropdown-inner">
                                        <ul>
                                            <li><a href="/frontend/shop-grid-right.php"> <img src="/frontend/assets/imgs/theme/icons/icon-1.svg" alt="">Milks and Dairies</a></li>
                                            <li><a href="/frontend/shop-grid-right.php"> <img src="/frontend/assets/imgs/theme/icons/icon-2.svg" alt="">Clothing & beauty</a></li>
                                        </ul>
                                        <ul class="end">
                                            <li><a href="/frontend/shop-grid-right.php"> <img src="/frontend/assets/imgs/theme/icons/icon-3.svg" alt="">Wines & Drinks</a></li>
                                            <li><a href="/frontend/shop-grid-right.php"> <img src="/frontend/assets/imgs/theme/icons/icon-4.svg" alt="">Fresh Seafood</a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul>
                                    ...
                                    <li><a class="active" href="/frontend/index.php">Home <i class="fi-rs-angle-down"></i></a>
                                        <ul class="sub-menu">
                                    ...
                                    <li><a href="/frontend/shop-grid-right.php">Shop <i class="fi-rs-angle-down"></i></a>
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="/frontend/#">Single Product <i class="fi-rs-angle-right"></i></a>
                                                <ul class="level-menu">
                                    ...
                                    <li class="position-static"><a href="/frontend/#">Mega menu <i class="fi-rs-angle-down"></i></a>
                                        <ul class="mega-menu">
                                    ...
                                    <li><a href="/frontend/blog-category-grid.php">Blog <i class="fi-rs-angle-down"></i></a>
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="/frontend/#">Single Post <i class="fi-rs-angle-right"></i></a>
                                    ...
                                    <li><a href="/frontend/#">Pages <i class="fi-rs-angle-down"></i></a>
                                        <ul class="sub-menu">
            ...
            <div class="row">
                    ...
                    <div class="row mb-50">
                        <div class="col-lg-6 mb-sm-15 mb-lg-0 mb-md-3">
                            <div class="toggle_info">
                                <span><i class="fi-rs-user mr-10"></i><span class="text-muted font-lg">Already have an account?</span> <a href="/frontend/#loginform" data-bs-toggle="collapse" class="collapsed font-lg" aria-expanded="false">Click here to login</a></span>
                            </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="login_footer form-group">
                                            ...
                                            <a href="/frontend/#">Forgot password?</a>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="checkbox">
                                    <div class="custome-checkbox">
                                        ...
                                        <label class="form-check-label label_info" data-bs-toggle="collapse" href="/frontend/#collapsePassword" data-target="#collapsePassword" aria-controls="collapsePassword" for="createaccount"><span>Create an account?</span></label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <div class="chek-form">
                                        <div class="custome-checkbox">
                                            ...
                                            <label class="form-check-label label_info" data-bs-toggle="collapse" data-target="#collapseAddress" href="/frontend/#collapseAddress" aria-controls="collapseAddress" for="differentaddress"><span>Ship to a different address?</span></label>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-5">
                    <div class="border p-40 cart-totals ml-30 mb-50">
                        ...
                        <div class="table-responsive order_table checkout">
                            <table class="table no-border">
                                <tbody>
                                    <tr>
                                        <td class="image product-thumbnail"><img src="/frontend/assets/imgs/shop/product-1-1.jpg" alt="#"></td>
                                        <td>
                                            <h6 class="w-160 mb-5"><a href="/frontend/shop-product-full.php" class="text-heading">Yidarton Women Summer Blue</a></h6></span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="w-160 mb-5"><a href="/frontend/shop-product-full.php" class="text-heading">Seeds of Change Organic Quinoa</a></h6></span>
                                            <div class="product-rate-cover">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width:90%">
                                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="w-160 mb-5"><a href="/frontend/shop-product-full.php" class="text-heading">Angie’s Boomchickapop Sweet </a></h6></span>
                                            <div class="product-rate-cover">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width:90%">
                                                    </div>
                    ...
                    <div class="payment ml-30">
                        ...
                        <a href="/frontend/#" class="btn btn-fill-out btn-block mt-30">Place an Order<i class="fi-rs-sign-out ml-15"></i></a>
                    </div>
                </div>
            </div>
        </div>
