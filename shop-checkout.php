...
<head>
    ...
    <!-- Template CSS -->
    <link rel="stylesheet" href="/frontendassets/css/main.css?v=4.0">
</head>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li><a href="/frontend#"><img src="assets/imgs/theme/flag-fr.png" alt="">Français</a></li>
                                        <li><a href="/frontend#"><img src="assets/imgs/theme/flag-dt.png" alt="">Deutsch</a></li>
                                        <li><a href="/frontend#"><img src="assets/imgs/theme/flag-ru.png" alt="">Pусский</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a class="language-dropdown-active" href="/frontend#">USD <i class="fi-rs-angle-small-down"></i></a>
                                    <ul class="language-dropdown">
                                        <li><a href="/frontend#"><img src="assets/imgs/theme/flag-fr.png" alt="">INR</a></li>
                                        <li><a href="/frontend#"><img src="assets/imgs/theme/flag-dt.png" alt="">MBP</a></li>
                                        <li><a href="/frontend#"><img src="assets/imgs/theme/flag-ru.png" alt="">EU</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="main-categori-wrap d-none d-lg-block">
                            ...
                            <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                                <div class="d-flex categori-dropdown-inner">
                                    <ul>
                                        <li><a href="/frontendshop-grid-right.php"> <img src="assets/imgs/theme/icons/category-1.svg" alt="">Milks and Dairies</a></li>
                                        <li><a href="/frontendshop-grid-right.php"> <img src="assets/imgs/theme/icons/category-2.svg" alt="">Clothing & beauty</a></li>
                                        <li><a href="/frontendshop-grid-right.php"> <img src="assets/imgs/theme/icons/category-3.svg" alt="">Pet Foods & Toy</a></li>
                                        <li><a href="/frontendshop-grid-right.php"> <img src="assets/imgs/theme/icons/category-4.svg" alt="">Baking material</a></li>
                                        <li><a href="/frontendshop-grid-right.php"> <img src="assets/imgs/theme/icons/category-5.svg" alt="">Fresh Fruit</a></li>
                                    </ul>
                                    <ul class="end">
                                        <li><a href="/frontendshop-grid-right.php"> <img src="assets/imgs/theme/icons/category-6.svg" alt="">Wines & Drinks</a></li>
                                        <li><a href="/frontendshop-grid-right.php"> <img src="assets/imgs/theme/icons/category-7.svg" alt="">Fresh Seafood</a></li>
                                        <li><a href="/frontendshop-grid-right.php"> <img src="assets/imgs/theme/icons/category-8.svg" alt="">Fast food</a></li>
                                        <li><a href="/frontendshop-grid-right.php"> <img src="assets/imgs/theme/icons/category-9.svg" alt="">Vegetables</a></li>
                                        <li><a href="/frontendshop-grid-right.php"> <img src="assets/imgs/theme/icons/category-10.svg" alt="">Bread and Juice</a></li>
                                    </ul>
                                </div>
                                <div class="more_slide_open" style="display: none;">
                                    <div class="d-flex categori-dropdown-inner">
                                        <ul>
                                            <li><a href="/frontendshop-grid-right.php"> <img src="assets/imgs/theme/icons/icon-1.svg" alt="">Milks and Dairies</a></li>
                                            <li><a href="/frontendshop-grid-right.php"> <img src="assets/imgs/theme/icons/icon-2.svg" alt="">Clothing & beauty</a></li>
                                        </ul>
                                        <ul class="end">
                                            <li><a href="/frontendshop-grid-right.php"> <img src="assets/imgs/theme/icons/icon-3.svg" alt="">Wines & Drinks</a></li>
                                            <li><a href="/frontendshop-grid-right.php"> <img src="assets/imgs/theme/icons/icon-4.svg" alt="">Fresh Seafood</a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul>
                                    ...
                                    <li><a class="active" href="/frontendindex.php">Home <i class="fi-rs-angle-down"></i></a>
                                        <ul class="sub-menu">
                                    ...
                                    <li><a href="/frontendshop-grid-right.php">Shop <i class="fi-rs-angle-down"></i></a>
                                        <ul class="sub-menu">
                                    ...
                                    <li><a href="/frontendblog-category-grid.php">Blog <i class="fi-rs-angle-down"></i></a>
                                        <ul class="sub-menu">
                            ...
                            <table class="table no-border">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="w-160 mb-5"><a href="/frontendshop-product-full.php" class="text-heading">Yidarton Women Summer Blue</a></h6></span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="w-160 mb-5"><a href="/frontendshop-product-full.php" class="text-heading">Seeds of Change Organic Quinoa</a></h6></span>
                                            <div class="product-rate-cover">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width:90%">
                                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="w-160 mb-5"><a href="/frontendshop-product-full.php" class="text-heading">Angie’s Boomchickapop Sweet </a></h6></span>
                                            <div class="product-rate-cover">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width:90%">
                                                    </div>
