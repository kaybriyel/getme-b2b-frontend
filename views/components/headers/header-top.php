      ...
      <div class="col-xl-3 col-lg-4">
        <div class="header-info">
          <ul>
            ...
            <li><a href="?layout=page&page=page-account">My Account</a></li>
            <li><a href="?layout=shop&page=wishlist">Wishlist</a></li>
            <li><a href="?layout=shop&page=order">Order Tracking</a></li>
          </ul>
        </div>
      </div>
