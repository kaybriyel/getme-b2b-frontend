                        ...
                        <tbody>
                            ...
                            <tr class="pr_title">
                                ...
                                <td class="product_name">
                                    <h6><a href="shop-product-full.php" class="text-heading">J.Crew Mercantile Women's Short</a></h6>
                                </td>
                                <td class="product_name">
                                    <h6><a href="shop-product-full.php" class="text-heading">Amazon Essentials Women's Tanks</a></h6>
                                </td>
                                <td class="product_name">
                                    <h6><a href="shop-product-full.php" class="text-heading">Amazon Brand - Daily Ritual Wom</a></h6>
                                </td>
                            </tr>
                            <tr class="pr_price">
