                    ...
                    <div class="col-lg-9 m-auto">
                        <div class="single-page pt-50 pr-30">
                                        ...
                                        <div class="single-header-meta">
                                            <div class="entry-meta meta-1 font-xs mt-15 mb-15">
                                                <a class="author-avatar" href="/frontend/#">
                                                    <img class="img-circle" src="/frontend/assets/imgs/blog/author-1.png" alt="">
                                                </a>
                                            ...
                                            <div class="social-icons single-share">
                                                <ul class="text-grey-5 d-inline-block">
                                                    <li class="mr-5"><a href="/frontend/#"><img src="/frontend/assets/imgs/theme/icons/icon-bookmark.svg" alt=""></a></li>
                                                    <li><a href="/frontend/#"><img src="/frontend/assets/imgs/theme/icons/icon-heart-2.svg" alt=""></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <figure class="single-thumbnail">
                                <img src="/frontend/assets/imgs/blog/blog-19.png" alt="">
                            </figure>
                            <div class="single-content">
                                <div class="row">
                                    <div class="col-xl-10 col-lg-12 m-auto">
                                        ...
                                        <img class="mb-30" src="/frontend/assets/imgs/blog/blog-21.png" alt="">
                                        ...
                                        <blockquote>
                                            <p>Integer eu faucibus <a href="/frontend/#">dolor</a><sup><a href="/frontend/#">[5]</a></sup>. Ut venenatis tincidunt diam elementum imperdiet. Etiam accumsan semper nisl eu congue. Sed aliquam magna erat, ac eleifend lacus rhoncus in.</p>
                                        </blockquote>
                                        ...
                                        <div class="entry-bottom mt-50 mb-30">
                                            <div class="tags w-50 w-sm-100">
                                                <a href="/frontend/blog-category-big.php" rel="tag" class="hover-up btn btn-sm btn-rounded mr-10">deer</a>
                                                <a href="/frontend/blog-category-big.php" rel="tag" class="hover-up btn btn-sm btn-rounded mr-10">nature</a>
                                                <a href="/frontend/blog-category-big.php" rel="tag" class="hover-up btn btn-sm btn-rounded mr-10">conserve</a>
                                            </div>
                                            <div class="social-icons single-share">
                                                <ul class="text-grey-5 d-inline-block">
                                                    <li><strong class="mr-10">Share this:</strong></li>
                                                    <li class="social-facebook"><a href="/frontend/#"><img src="/frontend/assets/imgs/theme/icons/icon-facebook.svg" alt=""></a></li>
                                                    <li class="social-twitter"> <a href="/frontend/#"><img src="/frontend/assets/imgs/theme/icons/icon-twitter.svg" alt=""></a></li>
                                                    <li class="social-instagram"><a href="/frontend/#"><img src="/frontend/assets/imgs/theme/icons/icon-instagram.svg" alt=""></a></li>
                                                    <li class="social-linkedin"><a href="/frontend/#"><img src="/frontend/assets/imgs/theme/icons/icon-pinterest.svg" alt=""></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <!--Author box-->
                                        <div class="author-bio p-30 mt-50 border-radius-15 bg-white">
                                            <div class="author-image mb-30">
                                                <a href="/frontend/author.php"><img src="/frontend/assets/imgs/blog/author-1.png" alt="" class="avatar"></a>
