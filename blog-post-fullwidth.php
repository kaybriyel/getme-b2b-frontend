                                        ...
                                        <div class="single-header-meta">
                                            ...
                                            <div class="social-icons single-share">
                                                <ul class="text-grey-5 d-inline-block">
                                                    <li class="mr-5"><a href="/frontend#"><img src="assets/imgs/theme/icons/icon-bookmark.svg" alt=""></a></li>
                                                    <li><a href="/frontend#"><img src="assets/imgs/theme/icons/icon-heart-2.svg" alt=""></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="entry-bottom mt-50 mb-30">
                                            ...
                                            <div class="social-icons single-share">
                                                <ul class="text-grey-5 d-inline-block">
                                                    ...
                                                    <li class="social-facebook"><a href="/frontend#"><img src="assets/imgs/theme/icons/icon-facebook.svg" alt=""></a></li>
                                                    <li class="social-twitter"> <a href="/frontend#"><img src="assets/imgs/theme/icons/icon-twitter.svg" alt=""></a></li>
                                                    <li class="social-instagram"><a href="/frontend#"><img src="assets/imgs/theme/icons/icon-instagram.svg" alt=""></a></li>
                                                    <li class="social-linkedin"><a href="/frontend#"><img src="assets/imgs/theme/icons/icon-pinterest.svg" alt=""></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <!--Author box-->
