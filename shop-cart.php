            ...
            <div class="row">
                <div class="col-lg-8 mb-40">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <h6 class="text-body"><a href="/frontend/#" class="text-muted"><i class="fi-rs-trash mr-5"></i>Clear Cart</a></h6>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <tbody>
                                <tr class="pt-30">
                                    ...
                                    <td class="product-des product-name">
                                        <h6 class="mb-5"><a class="product-name mb-10 text-heading" href="/frontend/shop-product-right.php">Field Roast Chao Cheese Creamy Original</a></h6>
                                    ...
                                    <td class="action text-center" data-title="Remove"><a href="/frontend/#" class="text-body"><i class="fi-rs-trash"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="custome-checkbox pl-30">
                                    ...
                                    <td class="product-des product-name">
                                        <h6 class="mb-5"><a class="product-name mb-10 text-heading" href="/frontend/shop-product-right.php">Blue Diamond Almonds Lightly Salted</a></h6>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width:90%">
                                                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="product-des product-name">
                                        <h6 class="mb-5"><a class="product-name mb-10 text-heading" href="/frontend/shop-product-right.php">Fresh Organic Mustard Leaves Bell Pepper</a></h6>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width:90%">
                                                </div>
                ...
                <div class="col-lg-4">
                    <div class="border p-md-4 cart-totals ml-30">
                        ...
                        <a href="/frontend/#" class="btn mb-20 w-100">Proceed To CheckOut<i class="fi-rs-sign-out ml-15"></i></a>
                    </div>
                </div>
            </div>
        </div>
