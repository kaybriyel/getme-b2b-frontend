...
<html class="no-js" lang="en">
    <head>
        ...
        <!--leaflet map-->
        <link rel="stylesheet" href="/frontend/https://unpkg.com/leaflet@1.7.1/dist/leaflet.css" integrity="sha512-xodZBNTC5n17Xt2atTPuE1HxjVMSvLVW9ocqUKLsCC5CXdbqCmblAshOMAS6/keqq/sMZMZ19scR4PsZChSR7A==" crossorigin="" />
    ...
    <body>
                            ...
                            <section class="mb-50">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 pl-50 d-lg-block d-none">
                                        <img class="border-radius-15 mt-50" src="/frontend/assets/imgs/page/contact-2.png" alt="" />
                                    </div>
                                </div>
                            </section>
                        </div>
        ...
        <script src="/frontend/assets/js/plugins/leaflet.js"></script>
        <!-- Template  JS -->
