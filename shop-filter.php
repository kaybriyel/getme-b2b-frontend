                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 mb-lg-0 mb-md-2 mb-sm-2">
                                    <div class="card">
                                        ...
                                        <div class="sidebar-widget widget-tags">
                                            <ul class="tags-list">
                                                <li class="hover-up">
                                                    <a href="/frontend/blog-category-grid.php"><i class="fi-rs-cross mr-10"></i>Milk</a>
                                                </li>
                                                <li class="hover-up">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="/frontend/shop-product-right.php">Blue Diamond Almonds Lightly natural</a></h2>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 90%"></div>
                                            </div>
