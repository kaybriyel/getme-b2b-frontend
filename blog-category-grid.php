                    ...
                    <div class="archive-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-9 text-end d-none d-xl-block">
                                <ul class="tags-list">
                                    <li class="hover-up">
                                        <a href="/frontend/blog-category-grid.php"><i class="fi-rs-cross mr-10"></i>Shopping</a>
                                    </li>
                                    <li class="hover-up active">
                                        <a href="/frontend/blog-category-grid.php"><i class="fi-rs-cross mr-10"></i>Recips</a>
                                    </li>
                                    <li class="hover-up">
                                        <a href="/frontend/blog-category-grid.php"><i class="fi-rs-cross mr-10"></i>Kitchen</a>
                                    </li>
                                    <li class="hover-up">
                                        <a href="/frontend/blog-category-grid.php"><i class="fi-rs-cross mr-10"></i>News</a>
                                    </li>
                                    <li class="hover-up mr-0">
                                        <a href="/frontend/blog-category-grid.php"><i class="fi-rs-cross mr-10"></i>Food</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-9">
                            <div class="shop-product-fillter mb-50 pr-30">
                                <div class="totall-product">
                                    <h2>
                                        <img class="w-36px mr-10" src="/frontend/assets/imgs/theme/icons/category-1.svg" alt="" />
                                        Recips Articles
                                    </h2>
                                </div>
                                    ...
                                    <div class="sort-by-cover">
                                        ...
                                        <div class="sort-by-dropdown">
                                            <ul>
                                                ...
                                                <li><a href="/frontend/#">Newest</a></li>
                                                <li><a href="/frontend/#">Most comments</a></li>
                                ...
                                <div class="row">
                                    <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                        <div class="post-thumb">
                                            <a href="/frontend/blog-post-right.php">
                                                <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-1.png" alt="" />
                                            </a>
                                            <div class="entry-meta">
                                                <a class="entry-meta meta-2" href="/frontend/blog-category-grid.php"><i class="fi-rs-heart"></i></a>
                                            </div>
                                        </div>
                                        <div class="entry-content-2">
                                            <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="/frontend/blog-category-grid.php">Side Dish</a></h6>
                                            <h4 class="post-title mb-15">
                                                <a href="/frontend/blog-post-right.php">The Intermediate Guide to Healthy Food</a>
                                            </h4>
                                    ...
                                    <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                        <div class="post-thumb">
                                            <a href="/frontend/blog-post-right.php">
                                                <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-2.png" alt="" />
                                            </a>
                                        </div>
                                        <div class="entry-content-2">
                                            <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="/frontend/blog-category-grid.php">Soups and Stews</a></h6>
                                            <h4 class="post-title mb-15">
                                                <a href="/frontend/blog-post-right.php">Summer Quinoa Salad Jars with Lemon Dill</a>
                                            </h4>
                                            <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                                <div>
                                                    <span class="post-on mr-10">25 April 2021</span>
                                    ...
                                    <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                        <div class="post-thumb">
                                            <a href="/frontend/blog-post-right.php">
                                                <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-3.png" alt="" />
                                            </a>
                                            <div class="entry-meta">
                                                <a class="entry-meta meta-2" href="/frontend/blog-category-grid.php"><i class="fi-rs-link"></i></a>
                                            </div>
                                        </div>
                                        <div class="entry-content-2">
                                            <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="/frontend/blog-category-grid.php">Salad</a></h6>
                                            <h4 class="post-title mb-15">
                                                <a href="/frontend/blog-post-right.php">Caprese Chicken with Smashed Potatoes</a>
                                            </h4>
                                            <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                                <div>
                                                    <span class="post-on mr-10">25 April 2021</span>
                                    ...
                                    <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                        <div class="post-thumb">
                                            <a href="/frontend/blog-post-right.php">
                                                <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-4.png" alt="" />
                                            </a>
                                        </div>
                                        <div class="entry-content-2">
                                            <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="/frontend/blog-category-grid.php">Dessert</a></h6>
                                            <h4 class="post-title mb-15">
                                                <a href="/frontend/blog-post-right.php">Harissa Chickpeas with Whipped Feta</a>
                                            </h4>
                                            <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                                <div>
                                                    <span class="post-on mr-10">25 April 2021</span>
                                    ...
                                    <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                        <div class="post-thumb">
                                            <a href="/frontend/blog-post-right.php">
                                                <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-5.png" alt="" />
                                            </a>
                                        </div>
                                        <div class="entry-content-2">
                                            <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="/frontend/blog-category-grid.php">Breakfast</a></h6>
                                            <h4 class="post-title mb-15">
                                                <a href="/frontend/blog-post-right.php">Almond Butter Chocolate Chip Zucchini Bars</a>
                                            </h4>
                                            <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                                <div>
                                                    <span class="post-on mr-10">25 April 2021</span>
                                    ...
                                    <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                        <div class="post-thumb">
                                            <a href="/frontend/blog-post-right.php">
                                                <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-6.png" alt="" />
                                            </a>
                                            <div class="entry-meta">
                                                <a class="entry-meta meta-2" href="/frontend/blog-category-grid.php"><i class="fi-rs-picture"></i></a>
                                            </div>
                                        </div>
                                        <div class="entry-content-2">
                                            <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="/frontend/blog-category-grid.php">Vegan</a></h6>
                                            <h4 class="post-title mb-15">
                                                <a href="/frontend/blog-post-right.php">Smoky Beans & Greens Tacos with Aji Verde</a>
                                            </h4>
                                            <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                                <div>
                                                    <span class="post-on mr-10">25 April 2021</span>
                                    ...
                                    <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                        <div class="post-thumb">
                                            <a href="/frontend/blog-post-right.php">
                                                <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-7.png" alt="" />
                                            </a>
                                            <div class="entry-meta">
                                                <a class="entry-meta meta-2" href="/frontend/blog-category-grid.php"><i class="fi-rs-play-alt"></i></a>
                                            </div>
                                        </div>
                                        <div class="entry-content-2">
                                            <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="/frontend/blog-category-grid.php">Gluten Free</a></h6>
                                            <h4 class="post-title mb-15">
                                                <a href="/frontend/blog-post-right.php">Sticky Ginger Rice Bowls with Pickled Veg</a>
                                            </h4>
                                            <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                                <div>
                                                    <span class="post-on mr-10">25 April 2021</span>
                                    ...
                                    <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                        <div class="post-thumb">
                                            <a href="/frontend/blog-post-right.php">
                                                <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-8.png" alt="" />
                                            </a>
                                        </div>
                                        <div class="entry-content-2">
                                            <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="/frontend/blog-category-grid.php">Side Dish</a></h6>
                                            <h4 class="post-title mb-15">
                                                <a href="/frontend/blog-post-right.php">Creamy Garlic Sun-Dried Tomato Pasta</a>
                                            </h4>
                                            <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                                <div>
                                                    <span class="post-on mr-10">25 April 2021</span>
                                    ...
                                    <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                        <div class="post-thumb">
                                            <a href="/frontend/blog-post-right.php">
                                                <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-9.png" alt="" />
                                            </a>
                                        </div>
                                        <div class="entry-content-2">
                                            <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="/frontend/blog-category-grid.php">Dairy Free</a></h6>
                                            <h4 class="post-title mb-15">
                                                <a href="/frontend/blog-post-right.php">The Absolute Easiest Spinach and Pizza</a>
                                            </h4>
                                            <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                                <div>
                                                    <span class="post-on mr-10">25 April 2021</span>
                                    ...
                                    <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                        <div class="post-thumb">
                                            <a href="/frontend/blog-post-right.php">
                                                <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-10.png" alt="" />
                                            </a>
                                        </div>
                                        <div class="entry-content-2">
                                            <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="/frontend/blog-category-grid.php">Salad</a></h6>
                                            <h4 class="post-title mb-15">
                                                <a href="/frontend/blog-post-right.php">Sticky Ginger Rice Bowls with Pickled</a>
                                            </h4>
                                            <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                                <div>
                                                    <span class="post-on mr-10">25 April 2021</span>
                                    ...
                                    <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                        ...
                                        <div class="entry-content-2">
                                            <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="/frontend/blog-category-grid.php">Soups</a></h6>
                                            <h4 class="post-title mb-15">
                                                <a href="/frontend/blog-post-right.php">The Best Soft Chocolate Chip Cookies</a>
                                            </h4>
                                            <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                                <div>
                                                    <span class="post-on mr-10">25 April 2021</span>
                                    ...
                                    <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                        <div class="post-thumb">
                                            <a href="/frontend/blog-post-right.php">
                                                <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-12.png" alt="" />
                                            </a>
                                        </div>
                                        <div class="entry-content-2">
                                            <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="/frontend/blog-category-grid.php">Vegetarian</a></h6>
                                            <h4 class="post-title mb-15">
                                                <a href="/frontend/blog-post-right.php">Baked Mozzarella Chicken Rolls</a>
                                            </h4>
                                            <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                                <div>
                                                    <span class="post-on mr-10">25 April 2021</span>
                                    ...
                                    <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                        <div class="post-thumb">
                                            <a href="/frontend/blog-post-right.php">
                                                <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-13.png" alt="" />
                                            </a>
                                        </div>
                                        <div class="entry-content-2">
                                            <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="/frontend/blog-category-grid.php"> Dessert </a></h6>
                                            <h4 class="post-title mb-15">
                                                <a href="/frontend/blog-post-right.php">The Best Avocado Egg Salad</a>
                                            </h4>
                                            <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                                <div>
                                                    <span class="post-on mr-10">25 April 2021</span>
                                    ...
                                    <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                        <div class="post-thumb">
                                            <a href="/frontend/blog-post-right.php">
                                                <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-14.png" alt="" />
                                            </a>
                                        </div>
                                        <div class="entry-content-2">
                                            <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="/frontend/blog-category-grid.php">Vegetarian</a></h6>
                                            <h4 class="post-title mb-15">
                                                <a href="/frontend/blog-post-right.php">The litigants on the screen are not actors</a>
                                            </h4>
                                            <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                                <div>
                                                    <span class="post-on mr-10">25 April 2021</span>
                                    ...
                                    <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                        <div class="post-thumb">
                                            <a href="/frontend/blog-post-right.php">
                                                <img class="border-radius-15" src="/frontend/assets/imgs/blog/blog-15.png" alt="" />
                                            </a>
                                        </div>
                                        <div class="entry-content-2">
                                            <h6 class="mb-10 font-sm"><a class="entry-meta text-muted" href="/frontend/blog-category-grid.php">Vegetarian</a></h6>
                        ...
                        <div class="col-lg-3 primary-sidebar sticky-sidebar">
                            <div class="widget-area">
                                ...
                                <div class="sidebar-widget product-sidebar mb-50 p-30 bg-grey border-radius-10">
                                    ...
                                    <div class="single-post clearfix">
                                        <div class="image">
                                            <img src="/frontend/assets/imgs/shop/thumbnail-6.jpg" alt="#" />
                                        </div>
                                        <div class="content pt-10">
                                            <h6><a href="/frontend/shop-product-detail.php">Lorem, ipsum</a></h6>
                                            <p class="price mb-0 mt-5">$25</p>
                                            <div class="product-rate">
                                                <div class="product-rating" style="width: 60%"></div>
                                            </div>
                                ...
                                <div class="sidebar-widget widget_instagram mb-50">
                                    ...
                                    <div class="instagram-gellay">
                                        <ul class="insta-feed">
                                            <li>
                                                <a href="/frontend/#"><img class="border-radius-5" src="/frontend/assets/imgs/shop/thumbnail-1.jpg" alt="" /></a>
                                            </li>
                                            <li>
                                                <a href="/frontend/#"><img class="border-radius-5" src="/frontend/assets/imgs/shop/thumbnail-2.jpg" alt="" /></a>
                                            </li>
                                            <li>
                                                <a href="/frontend/#"><img class="border-radius-5" src="/frontend/assets/imgs/shop/thumbnail-3.jpg" alt="" /></a>
                                            </li>
                                            <li>
                                                <a href="/frontend/#"><img class="border-radius-5" src="/frontend/assets/imgs/shop/thumbnail-4.jpg" alt="" /></a>
                                            </li>
                                            <li>
                                                <a href="/frontend/#"><img class="border-radius-5" src="/frontend/assets/imgs/shop/thumbnail-5.jpg" alt="" /></a>
                                            </li>
                                            <li>
                                                <a href="/frontend/#"><img class="border-radius-5" src="/frontend/assets/imgs/shop/thumbnail-6.jpg" alt="" /></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="sidebar-widget widget-tags mb-50 pb-10">
                                    ...
                                    <ul class="tags-list">
                                        ...
                                        <li class="hover-up">
                                            <a href="/frontend/blog-category-grid.php"><i class="fi-rs-cross mr-10"></i>Smoothie</a>
                                        </li>
                                        <li class="hover-up">
                                            <a href="/frontend/blog-category-grid.php"><i class="fi-rs-cross mr-10"></i>Fruit</a>
                                        </li>
                                        <li class="hover-up mr-0">
                                            <a href="/frontend/blog-category-grid.php"><i class="fi-rs-cross mr-10"></i>Salad</a>
                                        </li>
                                        <li class="hover-up mr-0">
                                            <a href="/frontend/blog-category-grid.php"><i class="fi-rs-cross mr-10"></i>Appetizer</a>
                                        </li>
                                    </ul>
                                </div>
